...
from emac.nn.attention import LocalMHA
from emac.nn.quantize import Phi
...
class CodecMixin:
    ...
    def decompress(
        self,
        obj: Union[str, Path, EMACFile],
        verbose: bool = False,
        depth: str = 'full'
    ) -> AudioSignal:
        """Reconstruct audio from a given .emac file

        Parameters
        ----------
        obj : Union[str, Path, EMACFile]
            .emac file location or corresponding EMACFile object.
        verbose : bool, optional
